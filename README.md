...
optional arguments:
  -d DATA_FILE, --data_file DATA_FILE
                        Path to the input TSP data file
  -k K_LIST [K_LIST ...], --k_list K_LIST [K_LIST ...]
                        Number of salesmen (e.g., 3 5 8 10)
  -r RANDOM_SEED, --random_seed RANDOM_SEED
                        Random seed for reproducibility (default: None, using system time )
